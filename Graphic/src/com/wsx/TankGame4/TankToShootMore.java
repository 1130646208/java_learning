 ...
 *
 */
public class TankToShootMore extends JFrame{
	MyPanel mp =null;
	public static void main(String[]args){
		TankToShootMore tg=new TankToShootMore();
	}
	
	//构造函数 
	public TankToShootMore(){
		mp=new MyPanel(); 
		//启动mp线程
	...
	public void paint(Graphics g){
		...
		for(int i=0;i<this.hero.ss.size();i++){
			...
			if(myShot!=null && myShot.isLive==true){
				g.draw3DRect(myShot.x-2, myShot.y-2, 4, 4, false);
			}
			//限制子弹数量
