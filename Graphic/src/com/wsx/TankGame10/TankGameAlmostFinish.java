...
public class TankGameAlmostFinish extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent arg0) {
		KeyBoardListener1 kbl=new KeyBoardListener1();
		...
		if(arg0.getActionCommand().equals("newGame")){
			...
			this.remove(ms);
			this.add(mp);
			this.addKeyListener(mp.kbl);//监听移动按键
			this.setVisible(true);
			//启动mp线程
...
//		image3=Toolkit.getDefaultToolkit().getImage(Panel.class.getResource("/bomb_3.gif"));
	...
	public void run() {
		...
		//判断panel中是否发生以下事件
		//刷新由keyboardlistener控制的坦克位置
		this.kbl.setHero(this.hero);
		this.hero=kbl.getHero();
		//判断是否有敌人坦克被击中
		this.hitEnemyTank();
		//击中我了没
		this.hitMe();
